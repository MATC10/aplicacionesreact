...
const valores=[{
    ...
    export const Datos = ({ children }) =>{
        ...
        const [profe, setProfe] = useState('none');
        const [lugar, setLugar] = useState('none');
        return(
            <Contexto.Provider value={{info, setInfo, idioma, setIdioma, profe, setProfe, lugar, setLugar}}>
                { children }
            </Contexto.Provider>
        )
    }